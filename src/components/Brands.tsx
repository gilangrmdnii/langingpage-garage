...
export default function Brands({ brands }: BrandsProps) {
  return (
    <section className="py-16 bg-gray-900" id="brands">
      <div className="max-w-7xl mx-auto px-6">
        <SectionTitle title="Our Trusted Brands" subtitle="We work with world-class car brands" />
